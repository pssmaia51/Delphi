object Frm_Usu: TFrm_Usu
  Left = 380
  Top = 171
  BorderStyle = bsSingle
  Caption = 'Formulario de Cadastro de Usuarios'
  ClientHeight = 309
  ClientWidth = 459
  Color = clWhite
  ...
  object Panel1: TPanel
    ...
    object Label6: TLabel
      ...
      Width = 157
      Height = 16
      Caption = 'For'#231'ar Troca de Senha ?'
      FocusControl = EditForcar
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object Label7: TLabel
      ...
      Width = 209
      Height = 16
      Caption = 'Travar Senha Apos Data Limite ?'
      FocusControl = Edittravar
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object Label8: TLabel
      ...
      Width = 135
      Height = 16
      Caption = 'Data de Inicio do Uso'
      FocusControl = Editini
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object Label9: TLabel
      ...
      Width = 194
      Height = 16
      Caption = 'Data Final pra Troca da Senha'
      FocusControl = Editfim
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object Editconfirme: TDBEdit
      ...
      PasswordChar = '#'
      TabOrder = 3
      OnExit = EditconfirmeExit
    end
    object EditForcar: TDBEdit
      Left = 173
      Top = 101
      Width = 25
      Height = 24
    ...
    object Editprevilegio: TDBEdit
      Left = 349
      Top = 186
      Width = 105
      Height = 24
      Ctl3D = False
      DataField = 'Previlegio'
      DataSource = Dm.Ds_Usu
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
    ...
    object DBComboBox1: TDBComboBox
      ...
      Items.Strings = (
        ...
        'Armazenagem'
        'Comercial'
        'Controller Log'#237'stico'
        'Estoque'
        'Financeiro'
        'Juridico'
        'Marketing'
        'Operacional'
        'Planejamento e demanda de estoques'
